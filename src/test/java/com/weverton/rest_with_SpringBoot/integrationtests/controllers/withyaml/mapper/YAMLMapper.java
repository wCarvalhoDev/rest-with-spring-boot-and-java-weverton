package com.weverton.rest_with_SpringBoot.integrationtests.controllers.withyaml.mapper;
...
public class YAMLMapper implements ObjectMapper {
    ...
    public Object deserialize(ObjectMapperDeserializationContext context) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Could not deserialize" + content, e);
        }
    }
    ...
    public Object serialize(ObjectMapperSerializationContext context) {
        try {
            ...
            throw new IllegalArgumentException("Could not serialize" + context.getObjectToSerialize(), e);
        }
    }
}
